      ...
      <div className="card settings-card">
        ...
        <div className="settings-logo">
          ...
          >
            ...
            >
              <Upload size={14} style={{ marginRight: 4 }} /> Upload School Logo
            </button>
            {logoUrl && (
              <button
                type="button"
                ...
                style={{ color: "#ef4444" }}
              >
                <X size={14} style={{ marginRight: 4 }} /> Remove Logo
              </button>
            )}
          </div>
          <input
        ...
        <div className="settings-form">
          ...
          <div className="form-group">
            <label htmlFor="affiliation">Affiliation No.</label>
            <input
              id="affiliation"
              value={affiliation}
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              {signatureUrl && (
                <button
                  ...
                  style={{ color: "#ef4444" }}
                >
                  <X size={14} style={{ marginRight: 4 }} /> Remove
                </button>
              )}
            </div>
            <input
